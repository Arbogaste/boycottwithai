...
The project repository contained a file named `stuff` with detailed operational instructions for sabotage, disruption, or other activities that could cause harm or illegal actions.

We will not publish, distribute, or integrate instructions that enable illegal or violent activities. Instead, this site provides:

- Ethical, non-violent campaigning methods.
